...
%
\typeout{************************************************}
\typeout{Chapter 4 One Tricky Integral}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 4.1 \(\displaystyle \int_0^\pi \sin(x) \; dx\)}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Chapter 5 Integration by Substitution}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 5.3 Antiderivatives by Substitution}
\typeout{************************************************}
%
...
\item{}Plug in your work from the last two tasks into \hyperref[x:task:task-rewrite-chain-rule-as-antiderivative]{Task~{\xreffont\ref{g:activity:idm546}}.{\xreffont\ref{x:task:task-rewrite-chain-rule-as-antiderivative}}}.%
...
%
\typeout{************************************************}
\typeout{Section 5.4 Definite Integrals by Substitution}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Chapter 6 Inverse Trigonometric Functions}
\typeout{************************************************}
%
...
\typeout{************************************************}
%
\begin{sectionptx}{Introduction}{}{Introduction}{}{}{g:section:idm650}
...
\begin{activity}{}{g:activity:idm653}%
...
%
\typeout{************************************************}
\typeout{Section 6.2 Some Practice}
\typeout{************************************************}
%
\begin{sectionptx}{Some Practice}{}{Some Practice}{}{}{g:section:idm670}
\begin{activity}{}{g:activity:idm672}%
...
\end{activity}
\begin{activity}{}{g:activity:idm686}%
...
\end{activity}
\begin{activity}{}{g:activity:idm692}%
